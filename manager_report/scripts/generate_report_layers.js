...
function populateForm(fileData) {
    ...
    buildingWorks.forEach((buildingWork, index) => {
        ...
        if (buildingWork.type == "Foundation") {
            ...
            removeChildrenNodes('panelRowP', 'panel');
            removeChildrenNodes('panelRowP', 'panelFirst');
            ...
            {
                panelRowElements = [
                    document.getElementById('panelRowP'),
                ...
                panelRowSizes = [
                    parseInt(document.getElementById('panelRowPSize').value),
...
addPanelRow(document.getElementById('panelRowP')); //, 'N'); //, 'NORTH');
