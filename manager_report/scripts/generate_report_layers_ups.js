...
function populateForm(fileData) {
    ...
    buildingWorks.forEach((buildingWork, index) => {
        ...
        if (buildingWork.type == "Foundation") {
            ...
            removeChildrenNodes('panelRowP0', 'panel');
            removeChildrenNodes('panelRowP0', 'panelFirst');
            removeChildrenNodes('panelRowP1', 'panel');
            removeChildrenNodes('panelRowP1', 'panelFirst');
            removeChildrenNodes('panelRowP2', 'panel');
            removeChildrenNodes('panelRowP2', 'panelFirst');
            removeChildrenNodes('panelRowP3', 'panel');
            removeChildrenNodes('panelRowP3', 'panelFirst');
